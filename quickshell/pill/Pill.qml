...
PanelWindow {
    ...
    Rectangle {
        ...
        Item {
            anchors.fill: parent
            visible: root.themePickerOpen && !root.wallpaperPickerOpen
            opacity: root.themePickerOpen && !root.wallpaperPickerOpen ? island.morphCloseness : 0
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                if (parent.selected)
                                    root.applyTheme(parent.modelData)
                                else
                                    root.themeIndex = parent.index
                            }
                        }
                    }
                }
        ...
        Item {
            ...
            opacity: root.wallpaperPickerOpen ? island.morphCloseness : 0
            ...
            Item {
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        required property int index
                        required property string modelData
                        readonly property bool selected: index === root.wallpaperIndex
                        x: parent.width / 2 - width / 2 + (index - root.wallpaperIndex) * 130
                        ...
                        ClippingRectangle {
                            ...
                            Image {
                                anchors.fill: parent
                                source: "file://" + root.wallDir + "/" + thumbnail.modelData
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                if (thumbnail.selected)
                                    root.applyWallpaper(thumbnail.modelData)
                                else
                                    root.wallpaperIndex = thumbnail.index
                            }
                        }
                    }
                }
