...
hl.bind(mod .. " + V", hl.dsp.exec_cmd("cliphist list | fuzzel --dmenu --lines 20 --width 80 | cliphist decode | wl-copy"))
...
hl.bind(mod .. " + CTRL + S", hl.dsp.exec_cmd(os.getenv("HOME") .. "/.local/bin/wf-record-fuzzel"))
